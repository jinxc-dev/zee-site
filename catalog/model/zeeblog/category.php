 ...
 */
class ModelZeeblogcategory extends Model {		
	...
	public function getTree( $id=null ){
		...
		$parent = 1 ;
		$output = $this->genTree( $parent, 1, 'zee-category' );
		return $output;
	}
	...
	public function genTree( $parent, $level , $class="" ){
		if( $this->hasChild($parent) ){
			...
			foreach( $data as $menu ){
				$output .='<li >';
					$output .= '<a href="'.$this->url->link('zeeblog/category',"id=".$menu['category_id']).'" title="'.$menu['title'].'">'.$menu['title']."</a>";
