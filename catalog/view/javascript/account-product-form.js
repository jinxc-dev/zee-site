					...
					for (var i = 0; i < data.files.length; i++) {
						$(".product_download_files").append(
							'<div class="ms-download">' +
			  				...
			  				(data.files[i].filePages ? '<a href="' + $('base').attr('href') + 'index.php?route=module/zeedownloads_pdfgen/jxRenderPdfgenDialog" class="ms-button-pdf" title="'+msGlobals.button_generate+'"></a>' : '') +
