...
<div style="clear: both; padding-top: 15px; border-top: 1px solid #EEEEEE;">
 <label for="newsletter"> <input type="checkbox" name="newsletter" value="1" id="newsletter" />
  <span><?php echo $entry_newsletter; ?></span></label>
  <br />
  <?php if ($shipping_required) { ?>
  
  <label for="shipping"><input type="checkbox" name="shipping_address" value="1" id="shipping" checked="checked" /> <span><?php echo $entry_shipping; ?></span></label>
  <br />
  <?php } ?>
  <br />
  <br />
