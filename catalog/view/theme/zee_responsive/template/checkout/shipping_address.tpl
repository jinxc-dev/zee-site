<?php if ($addresses) { ?>
<label for="shipping-address-existing"><input type="radio" name="shipping_address" value="existing" id="shipping-address-existing" checked="checked" />
 <span><?php echo $text_address_existing; ?></span></label>
...
<p><label for="shipping-address-new">
  <input type="radio" name="shipping_address" value="new" id="shipping-address-new" />
  <span><?php echo $text_address_new; ?></span></label>
</p>
<?php } ?>
