...
<div class="wrap-product"> 
  ...
  <?php } ?>
  <?php if ($products) { ?>
  <div id="tab-related" class="tab-content slide" data-interval="0">

    <div class="carousel-controls">
      <a class="carousel-control left" href="#tab-related" data-slide="prev">&lsaquo;</a>
      <a class="carousel-control right" href="#tab-related" data-slide="next">&rsaquo;</a>
    </div>
    ...
    <div class="box-product carousel-inner">
        ...
        <div class="item <?php if($i==1) {?>active<?php } ?>">
      			...
      			<?php } ?>
            	 <div class="myspan<?php echo $ispan;?> product_block <?php if($i%$cols == 0) { echo "last";} ?>">
                  ...
                  <div class="image">
                      ...
                      <a href="<?php echo $zimage;?>" id="colorbox_<?php echo $product['product_id'];?>" class="img product-zoom hidden-tablet hidden-phone" rel="nofollow" title="<?php echo $product['name']; ?>"><span class="fa fa-search-plus"></span></a>
                      <?php } ?>
  ...
  <div class="tags"><b><?php echo $text_tags; ?></b>
    ...
    <a href="<?php echo $tags[$i]['href']; ?>&filter_tag=<?php echo $tags[$i]['tag']; ?>"><?php echo $tags[$i]['tag']; ?></a>,
    <?php } else { ?>
    <a href="<?php echo $tags[$i]['href']; ?>&filter_tag=<?php echo $tags[$i]['tag']; ?>"><?php echo $tags[$i]['tag']; ?></a>
    <?php } ?>
    <?php } ?>
