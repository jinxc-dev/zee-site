...
$directories = glob( dirname(dirname(dirname(dirname(__FILE__)))).'/skins/*', GLOB_ONLYDIR);

 
?>

<div id="zee-paneltool" class="hidden-phone">
		...
		<div>
			...
			<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
				...
				<p>
					...
					<a href="<?php echo $this->url->link('common/home',"zeereset=?");?>" class="btn btn-small"><span>Reset</span></a>
				</p>
			</form>
		</div>
	</div>
...
<script type="text/javascript">
	$("#zee-paneltool .pn-action").click( function(){
		$(this).toggleClass("open");
		$("#zee-paneltool .panel-inner").toggle();
	} );
