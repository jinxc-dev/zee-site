...
class ControllermoduleZeecontentslider extends Controller {
	protected function index( $setting ) {
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/zeecontentslider.css')) {
			$this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/zeecontentslider.css');
		} else {
			$this->document->addStyle('catalog/view/theme/default/stylesheet/zeecontentslider.css');
		}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/zeecontentslider.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/zeecontentslider.tpl';
		} else {
			$this->template = 'default/template/module/zeecontentslider.tpl';
		}
