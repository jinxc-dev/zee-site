...
class ControllerModuleZeecustom extends Controller {
	protected function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/zeecustom.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/zeecustom.tpl';
		} else {
			$this->template = 'default/template/module/zeecustom.tpl';
		}
