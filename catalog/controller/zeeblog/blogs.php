 ...
 */
	class ControllerzeeblogBlogs extends Controller {
		...
		public function index() {  
			...
			if ($blogs) {
				...
				$this->data['latest_rss'] =  $this->url->link( 'zeeblog/blogs/rss' );
				...
				$pagination->url = $this->url->link('zeeblog/blogs',  $url . '&page={page}');
				
				$this->data['pagination'] = $pagination->render();
				
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/zeeblog/blogs.tpl')) {
					$this->template = $this->config->get('config_template') . '/template/zeeblog/blogs.tpl';
				} else {
					$this->template = 'default/template/zeeblog/blogs.tpl';
				}
