...
class ControllerSellerAccountProduct extends ControllerSellerAccount {
	...
	private function _initForm() {
		...
		$this->document->addScript('catalog/view/javascript/zeedownloads/account-product-form-options.js');
		$this->document->addScript('catalog/view/javascript/jquery/tabs.js');
		
		// ckeditor
		if($this->config->get('msconf_enable_rte'))
			$this->document->addScript('catalog/view/javascript/zeedownloads/ckeditor/ckeditor.js');
			...
			switch($this->data['seller']['commissions'][MsCommission::RATE_LISTING]['payment_method']) {
				case MsPayment::METHOD_PAYPAL:
					...
					$this->data['payment_data'] = array(
						...
						'notify_url' => $this->url->link('payment/zeedownloads-paypal/listingIPN'),
						'custom' => 'custom'
					);
