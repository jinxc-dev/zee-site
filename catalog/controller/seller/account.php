...
class ControllerSellerAccount extends Controller {
	public function __construct($registry) {
		...
		$this->document->addStyle('catalog/view/javascript/zeedownloads/datatables/css/jquery.dataTables.css');
		$this->document->addScript('catalog/view/javascript/zeedownloads/datatables/js/jquery.dataTables.min.js');
		$this->document->addScript('catalog/view/javascript/zeedownloads/common.js');
