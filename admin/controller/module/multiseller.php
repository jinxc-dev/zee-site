...
class ControllerModuleMultiseller extends ControllerMultisellerBase {
	...
	public function install() {
		...
		// ckeditor
		/*if (!copy(DIR_APPLICATION . 'view/javascript/ckeditor/', DIR_CATALOG . 'view/javascript/zeedownloads/')) {
			$this->session->data['error'] .= sprintf($this->language->get('ms_error_ckeditor'), DIR_APPLICATION . 'view/javascript/ckeditor/', DIR_CATALOG . 'view/javascript/zeedownloads/');
		}*/
		$this->session->data['error'] .= sprintf($this->language->get('ms_notice_ckeditor'), DIR_APPLICATION . 'view/javascript/ckeditor/', DIR_CATALOG . 'view/javascript/zeedownloads/ckeditor/');
	}
	...
	public function index() {
		...
		$this->document->addScript('view/javascript/zeedownloads/settings.js');
