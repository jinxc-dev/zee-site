...
/**
 * class ModelZeebloginstall 
 */
class ModelZeebloginstall extends Model { 
	public function checkInstall(){
		
		$sql = " SHOW TABLES LIKE '".DB_PREFIX."zeeblog_blog'";
		...
		$sql = " SELECT * FROM ".DB_PREFIX."extension WHERE `code` IN('zeeblogcategory','zeeblogcomment','zeebloglatest')";
		$query = $this->db->query( $sql );
		if($query->num_rows <= 0){
			$this->installModules();
		}
	...
	public function installModules(){
		$sql1 = "DELETE FROM ".DB_PREFIX."extension WHERE `code` IN('zeeblogcategory','zeeblogcomment','zeebloglatest')";
		$this->db->query($sql1);
		$sql = array();
		$sql[] = "INSERT INTO `".DB_PREFIX."extension` SET `type`='module', `code`='zeeblogcategory'";
		$sql[] = "INSERT INTO `".DB_PREFIX."extension` SET `type`='module', `code`='zeeblogcomment'";
		$sql[] = "INSERT INTO `".DB_PREFIX."extension` SET `type`='module', `code`='zeebloglatest'";
		foreach( $sql as $q ){
	...
	public function createTables(){
		...
		$sql[] = "
			...
			CREATE TABLE IF NOT EXISTS `".DB_PREFIX."zeeblog_blog` (
		...
		$sql[] = "
			...
			CREATE TABLE IF NOT EXISTS `".DB_PREFIX."zeeblog_blog_description` (
		...
		$sql[] = "
			...
			CREATE TABLE IF NOT EXISTS `".DB_PREFIX."zeeblog_category` (
		...
		$sql[] = "
				...
				CREATE TABLE IF NOT EXISTS `".DB_PREFIX."zeeblog_category_description` (
				  `category_id` int(11) NOT NULL,
				  `language_id` int(11) NOT NULL,
				  `title` varchar(255) NOT NULL,
				  `description` text NOT NULL,
		...
		$sql[] = "
					...
					CREATE TABLE IF NOT EXISTS `".DB_PREFIX."zeeblog_comment` (
...
INSERT INTO `".DB_PREFIX."zeeblog_blog` (`blog_id`, `category_id`, `position`, `created`, `status`, `user_id`, `hits`, `image`, `meta_keyword`, `meta_description`, `meta_title`, `date_modified`, `video_code`, `params`, `tags`, `featured`, `keyword`) VALUES
(7, 21, 2, '2013-03-09', 1, 1, 47, 'data/zeeblog/zee-i1.jpg', '', '', '', '2013-04-04', '', '', 'joomla, prestashop, magento', 1, ''),
(9, 21, 0, '2013-03-09', 1, 1, 74, 'data/zeeblog/zee-i1.jpg', '', '', '', '2013-04-04', '', '', 'prestashop, magento', 0, ''),
(10, 21, 0, '2013-03-09', 1, 1, 227, 'data/zeeblog/zee-i1.jpg', 'test test', '', 'Custom SEO Titlte', '2013-04-04', '&lt;iframe width=&quot;560&quot; height=&quot;315&quot; src=&quot;http://www.youtube.com/embed/-ZsFrs2O8pI&quot; frameborder=&quot;0&quot; allowfullscreen&gt;&lt;/iframe&gt;', '', 'prestashop', 0, ''),
(11, 21, 0, '2013-03-11', 1, 1, 58, 'data/zeeblog/zee-i1.jpg', '', '', '', '2013-04-04', '', '', 'zeestore', 0, '');
...
INSERT INTO  `".DB_PREFIX."zeeblog_blog_description`  (`blog_id`, `language_id`, `title`, `description`, `content`) VALUES
...
INSERT INTO `".DB_PREFIX."zeeblog_category`(`category_id`, `image`, `parent_id`, `is_group`, `width`, `submenu_width`, `colum_width`, `submenu_colum_width`, `item`, `colums`, `type`, `is_content`, `show_title`, `meta_keyword`, `level_depth`, `published`, `store_id`, `position`, `show_sub`, `url`, `target`, `privacy`, `position_type`, `menu_class`, `description`, `meta_description`, `meta_title`, `level`, `left`, `right`, `keyword`) VALUES
(1, '', 0, 2, NULL, NULL, NULL, NULL, NULL, '1', '', 2, 1, '1', 0, 1, 0, 0, 0, NULL, NULL, 0, 'top', NULL, NULL, NULL, NULL, -5, 34, 47, ''),
(20, 'data/zeeblog/zee-c3.jpg', 22, 2, NULL, NULL, NULL, NULL, NULL, '1', '', 2, 1, '1', 0, 1, 0, 3, 0, NULL, NULL, 0, 'top', 'test test', NULL, NULL, NULL, 0, 0, 0, ''),
(21, 'data/zeeblog/zee-c1.jpg', 22, 2, NULL, NULL, NULL, NULL, NULL, '1', '', 2, 1, '1', 0, 1, 0, 1, 0, NULL, NULL, 0, 'top', '', NULL, NULL, NULL, 0, 0, 0, ''),
(22, 'data/demo/canon_eos_5d_1.jpg', 1, 2, NULL, NULL, NULL, NULL, NULL, '1', '', 2, 1, '1', 0, 1, 0, 1, 0, NULL, NULL, 0, 'top', '', NULL, NULL, NULL, 0, 0, 0, ''),
(23, 'data/zeeblog/zee-c2.jpg', 22, 2, NULL, NULL, NULL, NULL, NULL, '1', '', 2, 1, '1', 0, 1, 0, 2, 0, NULL, NULL, 0, 'top', '', NULL, NULL, NULL, 0, 0, 0, ''),
...
INSERT INTO  `".DB_PREFIX."zeeblog_category_description`  (`category_id`, `language_id`, `title`, `description`) VALUES
(1, 1, 'ROOT', 'Menu Root'),
...
INSERT INTO `".DB_PREFIX."zeeblog_comment` (`comment_id`, `blog_id`, `comment`, `status`, `created`, `user`, `email`) VALUES
...
(8, 10, 'Commodo laoreet semper tincidunt lorem Vestibulum nunc at In Curabitur mag Commodo laoreet semper tincidunt lorem Vestibulum nunc at In Curabitur mag', 1, '2013-03-12 14:30:17', 'Test Test ', 'ngoisao@aa.com');
	...
	public function createDefaultConfig(){
		...
		$this->model_setting_setting->editSetting('zeeblog', $d );	
