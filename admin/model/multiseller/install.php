...
class ModelMultisellerInstall extends Model {
	...
	public function createSchema() {
		...
		`zs_attribute_id` int(11) DEFAULT NULL,
	...
	public function deleteData() {
		...
		// remove ZeeDownloads routes
		$this->db->query("DELETE FROM " . DB_PREFIX . "layout WHERE name = 'ZeeDownloads Seller Account'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "layout_route WHERE route = 'seller/account'");

		$this->db->query("DELETE FROM " . DB_PREFIX . "layout WHERE name = 'ZeeDownloads Seller List'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "layout_route WHERE route = 'seller/catalog-seller'");
		
		$this->db->query("DELETE FROM " . DB_PREFIX . "layout WHERE name = 'ZeeDownloads Seller Profile'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "layout_route WHERE route = 'seller/catalog-seller/profile'");

		$this->db->query("DELETE FROM " . DB_PREFIX . "layout WHERE name = 'ZeeDownloads Seller Products'");
