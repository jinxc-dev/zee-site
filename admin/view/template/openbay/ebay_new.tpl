        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div id="tab-listing-images">
                <table class="form">
                    ...
                    <tr>
                        <td><?php echo $lang_template; ?><span class="help"><a href="http://shop.openbaypro.com/zeestore_design_services/zeestore_theme_design/ebay_html_template_openbay_pro" target="_BLANK"><?php echo $lang_template_link; ?></a></span></td>
                        <td>
