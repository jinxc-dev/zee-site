			...
			<div class="content">
				<div class="box-columns">
					...
					<form id="form" enctype="multipart/form-data" method="post" action="<?php echo $action;?>">
							...
							<input type="hidden" name="zeeblog_comment[comment_id]"  value="<?php echo $comment['comment_id'];?>"/>
							 <table class="form">
								<tr>
								...
								<tr>
									...
									<td>
										<select name="zeeblog_comment[status]">
								...
								<tr>
									...
									<td><textarea rows="6" cols="90" name="zeeblog_comment[comment]"><?php echo $comment['comment'];?></textarea></td>
								</tr>
							 </table>
					</form>
