...
$module_key = isset($module_key)?$module_key:'zeebloglatest';
?>
        ...
        <div id="tab-module-<?php echo $module_key; ?>-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <div id="tab-language-<?php echo $module_key; ?>-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><textarea name="zeebloglatest_module[<?php echo $module_row; ?>][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_key; ?>-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['description'][$language['language_id']]) ? $module['description'][$language['language_id']] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
          <table class="form">
			<tr>
				...
				<td>
				  <select name="zeebloglatest_module[<?php echo $module_row; ?>][tabs]">
			...
			<tr>
				...
				<td class="left"><input type="text" name="zeebloglatest_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
                <input type="text" name="zeebloglatest_module[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" size="3"/>
			...
			<tr>
				 <td class="left"><?php echo $this->language->get("entry_carousel"); ?></td>
				  <td class="left">
                <input type="text" name="zeebloglatest_module[<?php echo $module_row; ?>][cols]" value="<?php echo $module['cols']; ?>" size="3"/> - 
				<input type="text" name="zeebloglatest_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="3"/>
            ...
            <tr>
              ...
              <td><select name="zeebloglatest_module[<?php echo $module_row; ?>][layout_id]">
            ...
            <tr>
              ...
              <td><select name="zeebloglatest_module[<?php echo $module_row; ?>][position]">
            ...
            <tr>
              ...
              <td><select name="zeebloglatest_module[<?php echo $module_row; ?>][status]">
            ...
            <tr>
              ...
              <td><input type="text" name="zeebloglatest_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
            </tr>
          </table>
        </div>
        <?php $module_row++; ?>
...
function addModuleLatest() {	
	...
	html += '          <td><textarea name="zeebloglatest_module[' + module_row_latest + '][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_key; ?>-' + module_row_latest + '-<?php echo $language['language_id']; ?>"></textarea></td>';
	html += '        </tr>';
	html += '      </table>';
	html += '    </div>';
	<?php } ?>
	...
	html += '    <td class="left"><select name="zeebloglatest_module[' + module_row_latest + '][tabs]"  >';
	<?php foreach ($tabs as $tab => $tabName ) { ?>
	...
	html += '    <td class="left"><input type="text" name="zeebloglatest_module[' + module_row_latest + '][width]" value="" size="3" /> <input type="text" name="zeebloglatest_module[' + module_row_latest + '][height]" value="" size="3" /></td>';
	html += '    <tr>';
	html += '    </tr>';
	html += '      <td><?php echo $this->language->get("entry_carousel"); ?></td>';
	html += '    <td class="left"><input type="text" name="zeebloglatest_module[' + module_row_latest + '][cols]" value="4" size="3" /> - <input type="text" name="zeebloglatest_module[' + module_row_latest + '][limit]" value="16" size="3" /></td>';
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td><?php echo $entry_layout; ?></td>';
	html += '      <td><select name="zeebloglatest_module[' + module_row_latest + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="zeebloglatest_module[' + module_row_latest + '][position]">';
	<?php foreach( $positions as $pos ) { ?>
	...
	html += '      <td><select name="zeebloglatest_module[' + module_row_latest + '][status]">';
	...
	html += '      <td><input type="text" name="zeebloglatest_module[' + module_row_latest + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
	html += '</div>';
