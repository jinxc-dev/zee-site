...
$module_key = isset($module_key)?$module_key:'zeeblogcategory';
?>
        ...
        <div id="tab-module-<?php echo $module_key; ?>-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="zeeblogcategory_module[<?php echo $module_row; ?>][layout_id]">
            ...
            <tr>
              ...
              <td><select name="zeeblogcategory_module[<?php echo $module_row; ?>][position]">
            ...
            <tr>
              ...
              <td><select name="zeeblogcategory_module[<?php echo $module_row; ?>][status]">
            ...
            <tr>
              ...
              <td><input type="text" name="zeeblogcategory_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
            </tr>
          </table>
        </div>
        <?php $module_row++; ?>
...
function addModuleCategory() {
	...
	html += '    <td class="left"><select name="zeeblogcategory_module[' + module_row_category + '][category_id]"><option value="1">ROOT</option><?php echo $options;?></select></td>';
	html += '    </tr>';
	
	html += '    <tr>';
	html += '      <td><?php echo $entry_layout; ?></td>';
	html += '      <td><select name="zeeblogcategory_module[' + module_row_category + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="zeeblogcategory_module[' + module_row_category + '][position]">';
	<?php foreach( $positions as $pos ) { ?>
	...
	html += '      <td><select name="zeeblogcategory_module[' + module_row_category + '][status]">';
	...
	html += '      <td><input type="text" name="zeeblogcategory_module[' + module_row_category + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
	html += '</div>';
