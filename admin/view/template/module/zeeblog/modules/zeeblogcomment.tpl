...
$module_key = isset($module_key)?$module_key:'zeeblogcomment';
?>
        ...
        <div id="tab-module-<?php echo $module_key; ?>-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <table class="form">
			...
			<tr>
				...
				<input type="text" name="zeeblogcomment_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="3"/>
            ...
            <tr>
              ...
              <td><select name="zeeblogcomment_module[<?php echo $module_row; ?>][layout_id]">
            ...
            <tr>
              ...
              <td><select name="zeeblogcomment_module[<?php echo $module_row; ?>][position]">
            ...
            <tr>
              ...
              <td><select name="zeeblogcomment_module[<?php echo $module_row; ?>][status]">
            ...
            <tr>
              ...
              <td><input type="text" name="zeeblogcomment_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
            </tr>
          </table>
        </div>
        <?php $module_row++; ?>
...
function addModuleComment() {	
	...
	html += '    <td class="left"><input type="text"  <input type="text" name="zeeblogcomment_module[' + module_row_comment + '][limit]" value="6" size="3" /></td>';
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td><?php echo $entry_layout; ?></td>';
	html += '      <td><select name="zeeblogcomment_module[' + module_row_comment + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="zeeblogcomment_module[' + module_row_comment + '][position]">';
	<?php foreach( $positions as $pos ) { ?>
	...
	html += '      <td><select name="zeeblogcomment_module[' + module_row_comment + '][status]">';
	...
	html += '      <td><input type="text" name="zeeblogcomment_module[' + module_row_comment + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
	html += '</div>';
