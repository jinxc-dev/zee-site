			...
			<div class="content">
				<div class="box-columns">
					...
					<div class="column2">
						...
						<div class="clearfix zee-toolbar" style="width:100%">
							<h4><?php echo $this->language->get('text_modules_setting');?></h4>
							<ul>
								<li>
									<a target="_blank" href="<?php echo $this->url->link('module/zeeblog/frontmodules','token='.$token.'#tab-module-zeeblogcategory');?>">
									<span class="icon-modules"></span><span><?php echo $this->language->get('module_latest');?></span></a>
								</li>
								<li>
									<a target="_blank" href="<?php echo $this->url->link('module/zeeblog/frontmodules','token='.$token.'#tab-module-zeeblogcomment');?>">
									<span class="icon-modules"></span><span><?php echo $this->language->get('module_comment');?></span></a>
								</li>
								<li>
									<a target="_blank" href="<?php echo $this->url->link('module/zeeblog/frontmodules','token='.$token.'#tab-module-zeebloglatest');?>">
									...
									<ol>	
										<li>
											<div><b><?php echo $this->language->get('text_front_page');?></b></div>
											 ...
											 <?php echo $this->language->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?route=zeeblog/blogs";?><br>
										...
										<li>
											...
											<?php echo $this->language->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?route=zeeblog/category&id=";?>CATEGORY_ID <br>
										...
										<li>
											...
											<?php echo $this->language->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?route=zeeblog/blog/id=";?>BLOG_ID<br>
										...
										<li>
											...
											<?php echo $this->language->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?route=zeeblog/blogs&tag=";?><b>TAG_NAME</b><br>
							...
							<div id="guide-links">
								...
								<a href="http://www.zeescripts.com/guides/zeeblog/#setup-seo"><?php echo $this->language->get('text_guide_seo');?></a> -
								<a href="http://www.zeescripts.com/guides/zeeblog/#manage-category"><?php echo $this->language->get('text_guide_category');?></a> -
								<a href="http://www.zeescripts.com/guides/zeeblog/#manage-blog"><?php echo $this->language->get('text_guide_blog');?></a> -
								<a href="http://www.zeescripts.com/guides/zeeblog/#module-setting"><?php echo $this->language->get('text_guide_module_setting');?></a>
							</div>
						</div>
					</div>
					...
					<div class="column2">
						...
						<div id="panel-lastest">
							...
							<?php foreach( $newest as $blog ) { ?>
								<li>
									<a href="<?php echo $this->url->link("module/zeeblog/blog","id=".$blog['blog_id']."&token=".$token);?>"><?php echo $blog['title'];?></a>
								</li>
							<?php } ?>
							</ul>
						</div>
						...
						<div id="panel-comments">
							<ul>
								...
								<li><a href="<?php echo $this->url->link("module/zeeblog/comment","id=".$comment['comment_id']."&token=".$token);?>"><?php echo utf8_substr($comment['comment'],0,100);?></a></li>
								<?php } ?>
							</ul>
						</div>
					</div>
