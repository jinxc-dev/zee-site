					...
					<table class="list">
					  ...
					  <tbody>
						...
						<tr>
						  ...
						  <td class="left"><a href="<?php echo $this->url->link('module/zeeblog/blog','id='.$comment['blog_id'].'&token='.$token);?>"><?php echo $comment['title'];?></a></td>
						  ...
						  <td class="right">
							<a href="<?php echo $this->url->link('module/zeeblog/comment','id='.$comment['comment_id'].'&token='.$token);?>"><?php echo $this->language->get('text_edit');?></a>
						  </td>
						</tr>
						<?php } ?>
					  </tbody>
