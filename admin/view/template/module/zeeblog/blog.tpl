<?php  echo $header;  ?>
			...
			<div class="content">
				<div class="box-columns">
					...
					<form id="form" enctype="multipart/form-data" method="post" action="<?php echo $action;?>">
							...
							<div id="tab-general">
									<input type="hidden" name="zeeblog_blog[blog_id]" value="<?php echo $blog['blog_id'];?>"/>
									<div>
										 <table class="form">
											<tr>
											...
											<tr>
												...
												<td>
													<select name="zeeblog_blog[status]">
											...
											<tr>
												...
												<td>
													<select name="zeeblog_blog[featured]">
													<?php foreach( $yesno as $k=>$v ) { ?>
											...
											<tr>
												...
												<td>
													<input type="text" name="zeeblog_blog[hits]" value="<?php echo $blog['hits'];?>">
												</td>
											</tr>
											<tr>
												<td><?php echo $this->language->get('entry_tags');?></td>
												<td>
													<input type="text" name="zeeblog_blog[tags]" value="<?php echo $blog['tags'];?>" size="150">
											...
											<tr>
												...
												<td>
													<input type="text" name="zeeblog_blog[created]" value="<?php echo $blog['created'];?>" class="date">
												</td>
											</tr>
											<tr>
												<td><?php echo $this->language->get('entry_creator');?></td>
												<td>
													<select name="zeeblog_blog[user_id]">
											...
											<td><input type="text" name="zeeblog_blog[keyword]" size="100" value="<?php echo $blog['keyword'];?>"/></td>
										</tr>
									  </table>
									</div>
									
									<div id="language-blog" class="htabs zeetabs">
									  ...
									  <div id="tab-language-<?php echo $language['language_id']; ?>">
										<table class="form">
										  <tr>
											...
											<td><input name="zeeblog_blog_description[<?php echo $language['language_id'];?>][title]" size="120" value="<?php echo $zeeblog_blog_descriptions[$language['language_id']]['title'];?>"/></td>
										  </tr>
										   <tr>
											<td><?php echo $this->language->get('entry_description');?></td>
											<td>
												<textarea name="zeeblog_blog_description[<?php echo $language['language_id'];?>][description]"  rows="6" cols="10"><?php echo $zeeblog_blog_descriptions[$language['language_id']]['description'];?></textarea>
											</td>
										  </tr>
										   </tr>
										   <tr>
											...
											<td>
												<textarea name="zeeblog_blog_description[<?php echo $language['language_id'];?>][content]"  rows="6" cols="10"><?php echo $zeeblog_blog_descriptions[$language['language_id']]['content'];?></textarea>
											</td>
										  </tr>
										</table>
									  </div>
								...
								<div>
									 <table class="form">
										...
										<tr>
										  ...
										  <input type="hidden" name="zeeblog_blog[image]" value="<?php echo $blog['image']; ?>" id="blog-image"  />
										  <br />
										...
										<tr>
											...
											<td><textarea  name="zeeblog_blog[video_code]" rows="6" cols="40"><?php echo $blog['video_code'];?></textarea></td>
										</tr>
								...
								<div class="zee-content" style="width:100%">
									<table class="form">
										...
										<tr>
											...
											<td><input type="text" name="zeeblog_blog[meta_title]" value="<?php echo $blog['meta_title'];?>"/></td>
										</tr>
										<tr>
											<td><?php echo $this->language->get('entry_meta_keyword');?></td>
											<td><textarea  name="zeeblog_blog[meta_keyword]"><?php echo $blog['meta_keyword'];?></textarea></td>
										</tr>
										<tr>
											<td><?php echo $this->language->get('entry_meta_description');?></td>
											<td><textarea  name="zeeblog_blog[meta_description]" rows="6" cols="40"><?php echo $blog['meta_description'];?></textarea></td>
										</tr>
 ...
 $('.date').datepicker({dateFormat: 'yy-mm-dd'});
  ...
  <?php foreach ($languages as $language) { ?>
CKEDITOR.replace('zeeblog_blog_description[<?php echo $language['language_id']; ?>][description]', {
...
<?php } ?>
  <?php foreach ($languages as $language) { ?>
CKEDITOR.replace('zeeblog_blog_description[<?php echo $language['language_id']; ?>][content]', {
	filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
	filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
