			...
			<div class="content"><form action="<?php echo $action;?>" method="post" id="form">
				<div class="box-columns">
					...
					<div class="module-setting-tabs htabs">
						<div class="nav-setting zeehtabs">
							...
							<div class="clearfix clear"></div>
								...
								<table class="form">
									...
									<tr>
										...
										<td>
											<input name="zeeblog[general_lwidth]" value="<?php echo $general_setting['general_lwidth'];?>" size="3"/> 
											x 
											<input size="3" name="zeeblog[general_lheight]" value="<?php echo $general_setting['general_lheight'];?>" />
										</td>
									</tr>
									<tr>
										<td><?php echo $this->language->get('entry_small_image_demension');?></td>
										<td>
											<input name="zeeblog[general_swidth]" value="<?php echo $general_setting['general_swidth'];?>" size="3"/>
											x 
											<input size="3" name="zeeblog[general_sheight]" value="<?php echo $general_setting['general_sheight'];?>" />
										</td>
									</tr>
									<tr>
										<td><?php echo $this->language->get('entry_xsmall_image_demension');?></td>
										<td>
											<input name="zeeblog[general_xwidth]" value="<?php echo $general_setting['general_xwidth'];?>" size="3"/> 
											x 
											<input size="3" name="zeeblog[general_xheight]" value="<?php echo $general_setting['general_xheight'];?>" />
										</td>
									</tr>
									
									<tr>
										<td><?php echo $this->language->get('entry_rss_limit');?></td>
										<td><input size="3" name="zeeblog[rss_limit_item]" value="<?php echo $general_setting['rss_limit_item'];?>" /></td>
									</tr>
									<tr>
										<td colspan="2">
									...
									<tr>
										...
										<td><input size="30" name="zeeblog[keyword_listing_blogs_page]" value="<?php echo $general_setting['keyword_listing_blogs_page'];?>" /></td>
									</tr>	
								</table>
								<div class="clearfix clear"></div>
						</div>
								 ...
								 <div class="clearfix clear"></div>
									<table class="form">
										<tr>
											...
											<td>
												<input name="zeeblog[children_columns]" value="<?php echo $general_setting['children_columns'];?>" size="10"/>
											</td>
										</tr>
										<tr>
											<td><?php echo $this->language->get('entry_category_image_demension');?></td>
											<td>
												<input name="zeeblog[general_cwidth]" value="<?php echo $general_setting['general_cwidth'];?>" size="3"/> 
												x 
												<input size="3" name="zeeblog[general_cheight]" value="<?php echo $general_setting['general_cheight'];?>" />
											</td>
										</tr> 
										<tr>
											<td><?php echo $this->language->get('entry_limit_leading_blogs');?></td>
											<td>
												<input name="zeeblog[cat_limit_leading_blog]" value="<?php echo $general_setting['cat_limit_leading_blog'];?>" size="10"/>
											</td>
										</tr>
										<tr>
											<td><?php echo $this->language->get('entry_limit_secondary_blogs');?></td>
											<td>
												<input name="zeeblog[cat_limit_secondary_blog]" value="<?php echo $general_setting['cat_limit_secondary_blog'];?>" size="10"/>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_leading_image_type]">
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_secondary_image_type]">
												<?php foreach( $image_types as $k => $v ) { ?>
										...
										<tr>
											...
											<td>
												<input name="zeeblog[cat_columns_leading_blog]" value="<?php echo $general_setting['cat_columns_leading_blogs'];?>" size="10"/>
											</td>
										</tr>
										<tr>
											<td><?php echo $this->language->get('entry_columns_secondary_blogs');?></td>
											<td>
												<input name="zeeblog[cat_columns_secondary_blogs]" value="<?php echo $general_setting['cat_columns_secondary_blogs'];?>" size="10"/>
											</td>
										</tr>
										<tr>
											<td><?php echo $this->language->get('entry_show_title');?></td>
											<td>
												<select name="zeeblog[cat_show_title]">
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_show_description]">
												<?php foreach( $yesno as $k => $v ) { ?>
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_show_readmore]">
												<?php foreach( $yesno as $k => $v ) { ?>
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_show_image]">
												<?php foreach( $yesno as $k => $v ) { ?>
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_show_author]">
												<?php foreach( $yesno as $k => $v ) { ?>
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_show_category]">
												<?php foreach( $yesno as $k => $v ) { ?>
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_show_created]">
												<?php foreach( $yesno as $k => $v ) { ?>
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_show_hits]">
												<?php foreach( $yesno as $k => $v ) { ?>
										...
										<tr>
											...
											<td>
												<select name="zeeblog[cat_show_comment_counter]">
												<?php foreach( $yesno as $k => $v ) { ?>
							...
							<div id="tab-blog-setting" >
								...
								<table class="form">
									...
									<tr>
										...
										<td>
											<select name="zeeblog[blog_image_type]">
											<?php foreach( $image_types as $k => $v ) { ?>
									...
									<tr>
										<td><?php echo $this->language->get('entry_show_title');?></td>
										<td>
											<select name="zeeblog[blog_show_title]">
											<?php foreach( $yesno as $k => $v ) { ?>
									...
									<tr>
										<td><?php echo $this->language->get('entry_show_image');?></td>
										<td>
											<select name="zeeblog[blog_show_image]">
											<?php foreach( $yesno as $k => $v ) { ?>
									...
									<tr>
										<td><?php echo $this->language->get('entry_show_author');?></td>
										<td>
											<select name="zeeblog[blog_show_author]">
											<?php foreach( $yesno as $k => $v ) { ?>
									...
									<tr>
										<td><?php echo $this->language->get('entry_show_category');?></td>
										<td>
											<select name="zeeblog[blog_show_category]">
											<?php foreach( $yesno as $k => $v ) { ?>
									...
									<tr>
										<td><?php echo $this->language->get('entry_show_created');?></td>
										<td>
											<select name="zeeblog[blog_show_created]">
											<?php foreach( $yesno as $k => $v ) { ?>
									...
									<tr>
										<td><?php echo $this->language->get('entry_show_comment_counter');?></td>
										<td>
											<select name="zeeblog[blog_show_comment_counter]">
											<?php foreach( $yesno as $k => $v ) { ?>
									...
									<tr>
										<td><?php echo $this->language->get('entry_show_hits');?></td>
										<td>
											<select name="zeeblog[blog_show_hits]">
											<?php foreach( $yesno as $k => $v ) { ?>
									...
									<tr>
										...
										<td>
											<select name="zeeblog[blog_show_comment_form]">
											<?php foreach( $yesno as $k => $v ) { ?>
									...
									<tr>
										...
										<td>
											<select name="zeeblog[comment_engine]">
									...
									<tr>
										...
										<td><input name="zeeblog[diquis_account]" value="<?php echo $general_setting['diquis_account'];?>" size="30"/>
										<br>
									...
									<tr>
										...
										<td>
											<input name="zeeblog[facebook_appid]" value="<?php echo $general_setting['facebook_appid'];?>" size="30"/>
									...
									<tr>
										...
										<td><input name="zeeblog[comment_limit]" value="<?php echo $general_setting['comment_limit'];?>" size="30"/></td>
									</tr>
									<tr>
										<td><?php echo $this->language->get('entry_facebook_width');?></td>
										<td><input name="zeeblog[facebook_width]" value="<?php echo $general_setting['facebook_width'];?>" size="30"/></td>
									</tr>
									
									<tr>
										<td><?php echo $this->language->get('entry_auto_publish_comment');?></td>
										<td>
											<select name="zeeblog[auto_publish_comment]">
											<?php foreach( $yesno as $k => $v ) { ?>
									...
									<tr>
										...
										<td>
											<select name="zeeblog[enable_recaptcha]">
											<?php foreach( $yesno as $k => $v ) { ?>
						...
						if(!empty($layout_modules)){
							foreach($layout_modules as $key=>$item_module){
								...
								if(!is_array($item_module)){
									...
									<div id="tab-module-<?php echo $key;?>">
										<div class="tab-inner">
											<input type="hidden" name="zeeblog[modules][]" value="<?php echo $key;?>"/>
											<?php
