  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				...
				<div class="megamenu-form">
					...
					<table class="form">
						<tr>
						  ...
						  <td><select name="zeemegamenu_module[<?php echo $module_row; ?>][layout_id]">
						...
						<tr>
						  ...
						  <td><select name="zeemegamenu_module[<?php echo $module_row; ?>][position]">
						...
						<tr>
						  ...
						  <td><select name="zeemegamenu_module[<?php echo $module_row; ?>][status]">
						...
						<tr>
						  ...
						  <td><input type="text" name="zeemegamenu_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
						</tr>
							</table>
							
					<div id="megamenu-form">
						<?php require( "zeemegamenu_info.tpl" );?>
					</div>
			...
			<div style="font-size:10px;color:#666"><p>Zee Mega Menu is free to use. it's released under GPL/V2. Power By <a href="http://www.zeescripts.com">ZeeScripts.Com</a></div>
      </form>
    </div>
  </div>
</div>
