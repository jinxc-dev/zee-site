		...
		<div>
			<table class="form">
						<tr>
						  ...
						  <td><select name="zeecontentslider_module[<?php echo $module_row; ?>][layout_id]">
						...
						<tr>
						  ...
						  <td><select name="zeecontentslider_module[<?php echo $module_row; ?>][position]">
						...
						<tr>
						  ...
						  <td><select name="zeecontentslider_module[<?php echo $module_row; ?>][status]">
						...
						<tr>
						  ...
						  <td><input type="text" name="zeecontentslider_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
						</tr>
						
						<tr>
						  <td><?php echo $this->language->get('text_auto_play'); ?></td>
						  <td><select name="zeecontentslider_module[<?php echo $module_row; ?>][auto_play]">
						...
						<tr>
						  ...
						  <td><input type="text" name="zeecontentslider_module[<?php echo $module_row; ?>][text_interval]" value="<?php echo $module['text_interval']; ?>" size="3" /></td>
						</tr>
						

						<tr>
						  <td><?php echo $entry_width; ?></td>
						  <td><input type="text" id="banner_width" name="zeecontentslider_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="8" /></td>
						</tr>
						<tr>
						  <td><?php echo $entry_height; ?></td>
						  <td><input type="text" id="banner_height" name="zeecontentslider_module[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" size="8" /></td>
						</tr>
						
						<tr>
						  <td><?php echo $entry_image_navigator; ?></td>
						  <td><select name="zeecontentslider_module[<?php echo $module_row; ?>][image_navigator]">
						...
						<tr>
						  ...
						  <td><input type="text" name="zeecontentslider_module[<?php echo $module_row; ?>][navimg_weight]" value="<?php echo $module['navimg_weight']; ?>" size="8" /></td>
						</tr>
						<tr>
						  <td><?php echo $entry_navigator_height; ?></td>
						  <td><input type="text" name="zeecontentslider_module[<?php echo $module_row; ?>][navimg_height]" value="<?php echo $module['navimg_height']; ?>" size="8" /></td>
						</tr>
						</table>
		</div>
...
<script type="text/javascript">
	 $("#content").delegate( ".insert-typo",'click',function(){   
		...
		$('#dialog').remove();
		$('#content').prepend('<div id="dialog" style="padding: 3px 0px 0px 0px;"><iframe src="index.php?route=module/zeecontentslider/typo&token=<?php echo $token;?>&field=' + encodeURIComponent(field) + '" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe></div>');
