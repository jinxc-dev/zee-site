...
<div class="typos">
	...
	<div class="typos-wrap">	
		...
		<?php foreach( $captions as $caption ) {  ?>
  		<div class="typo"><div class="zee-caption <?php echo $caption;?>" data-class="<?php echo $caption;?>">Use This Caption Typo</div></div>
  		<?php } ?>	
	 </div>
</div>  
...
$('div.typo').live('click', function() {  
	...
	parent.$('#dialog').data( "selected-class",$("div", this).attr("data-class")	 );
