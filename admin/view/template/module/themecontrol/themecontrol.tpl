    ...
    <div class="content">
	 ...
	 <div class="entry-theme">
		...
		<select name="themecontrol[default_theme]">
		 ...
		 - <a rel="" class="green custom-popup" href="http://www.zeescripts.com/guides/<?php echo $module['default_theme']?>" id="btn-guide"><?php echo $this->language->get('UserGuide');?></a>
		...
		<div id="tab-contents">
				...
				<div id="tab-support">
					...
					<h4>Need Help</h4>
					<p><i>
					View articles and tutorials <a href="http://www.zeestores.com" target="_blank">HERE!</a> </i>
					</p>
