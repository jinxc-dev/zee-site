...
<form  enctype="multipart/form-data" action="<?php echo $action; ?>" id="form" method="post">
	<div class="zee-customize" id="zee-customize">
...
<div id="main-preview">
	<iframe src="<?php echo $store;?>index.php?zeetoken=<?php echo $this->config->get('config_encryption');?>" ></iframe> 
</div>
...
$("#zee-customize .btn-show").click( function(){
