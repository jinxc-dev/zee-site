      ...
      <div class="heading">
       ...
       <div class="content">
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
              ...
              <select id="zeestores" name="zeenewsletter_module[stores]">
              ...
              <input type="hidden" value="<?php echo $store_id;?>" name="zeenewsletter_module[store_id]"/><br/><br/>
                    ...
                    <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
                        <table class="form">
                                  <tr>
                                    ...
                                    <td><select name="zeenewsletter_module[<?php echo $module_row; ?>][layout_id]">
                                  ...
                                  <tr>
                                    ...
                                    <td><select name="zeenewsletter_module[<?php echo $module_row; ?>][position]">
                                  ...
                                  <tr>
                                    ...
                                    <td><select name="zeenewsletter_module[<?php echo $module_row; ?>][status]">
                                  ...
                                  <tr>
                                    ...
                                    <td><input type="text" name="zeenewsletter_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo isset($module['sort_order'])?$module['sort_order']:''; ?>" size="3" /></td>
                                  </tr>
					
				<tr>
					<td><?php echo $this->language->get('entry_description'); ?></td>
					<td>
						<textarea name="zeenewsletter_module[<?php echo $module_row; ?>][description]" id="description-<?php echo $module_row; ?>"><?php echo isset($module['description']) ? $module['description'] : ''; ?></textarea><br/>
...
$(document).ready( function() {
  $('#zeestores').bind('change', function () {
      url = 'index.php?route=module/zeenewsletter/modules&token=<?php echo $token; ?>';
      var id = $(this).val();
      if (id) {
...
function addModule() {
  ...
  html += '      <td><select name="zeenewsletter_module[' + module_row + '][layout_id]">';
  <?php foreach ($layouts as $layout) { ?>
  ...
  html += '      <td><select name="zeenewsletter_module[' + module_row + '][position]">';
  <?php foreach( $positions as $pos ) { ?>
  ...
  html += '      <td><select name="zeenewsletter_module[' + module_row + '][status]">';
  ...
  html += '      <td><input type="text" name="zeenewsletter_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
  html += '    </tr>';
...
html += '<td>';
html += '<textarea name="zeenewsletter_module['+module_row+'][description]" id="description-'+module_row+'"></textarea><br/>';
