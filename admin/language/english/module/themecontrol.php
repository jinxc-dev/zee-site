...
$_['text_explain_modules_function'] = 'Drap and drop modules to Update Modules on expected Positions. And to sort theirs orders. <div class="zees-note">This feature only supports for modules developed by zeescripts or modules improved below positions.</div>';
...
$_['text_explain_custom_css'] = 'This is advanded feature for who having knowledge of CSS Language. You put css rules in below. <br>Css code store in file ZEE_YOURTHEME/stylesheet/local/custom.css.';
$_['text_customcss'] = 'Custom Css';
$_['text_customize_theme'] = '<b>Live Tools Customizing Theme</b>';
$_['text_explain_customize_theme'] = 'Click Live Customizing Theme to create custom-theme-profiles and they will be listed in above dropdown box. You select one profile theme to apply for your site <br>!important: All theme profiles are stored in folder <b>ZEE_YOURTHEME/stylesheet/customze</b>, it need permission 0755 to put files inside';
$_['text_clear_jscss_cache']  = 'Clear JS,Css Cache';
$_['text_complite_lesscss']  = 'Compile Less To Css';
$_['text_explain_customization'] = 'The framework supports you two way to put your customization on theme.<ul><li>You create your css file(s) and put in ZEE_YOURTHEME/stylesheet/local. All files will be loaded automatic</li><li>Or use tools at bellow</li></ul>';
...
$_['text_message_datasample_modules'] = '+ If you would like to install data sample for modules which will be taken look and feel like as demo on zeescripts. You click to Overrdie or Install link to start installing the sample of modules.<br><b>Please remember that you must to install below modules before using this tool</b>.<br> + If your moduled are ready installed, please backup data in any related table before installing our data sample' ;
...
$_['text_explain_internal_modules'] = '* <span class="label">Internal Modules</span><i> supports by zees framework and need not install, put on postions as zeestore module</i>';
//general 
...
$_['text_explain_compression']='Compression Feature allows to speed up webstore by merging, compressing js,css files. All cached files are stored  in folder <b>system/cache/zees-assets/</b>.<br> To clear cached you click to button CLEAR appearning Right Of this Screen';
