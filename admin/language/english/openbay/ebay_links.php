...
$_['lang_ajax_not_subtract']        = 'This product is set not to subtract stock in ZeeStore.';

// Text
$_['lang_link_desc1']               = 'Linking your items will allow for stock control on your eBay listings.';
$_['lang_link_desc2']               = 'For each item that is updated the local stock (the stock available in your ZeeStore store) will update your eBay listing';
...
$_['lang_text_linked_desc']         = 'Linked items are ZeeStore items that have a link to an eBay listing.';
$_['lang_text_unlinked_desc']       = 'Unlinked items are listings on your eBay account that do not link to any of your ZeeStore products.';
