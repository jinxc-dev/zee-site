...
$_['ms_db_upgrade'] = 'Please <a href="%s">click here</a> to upgrade your ZeeDownloads Marketplace database to the latest version.';
$_['ms_db_success'] = 'Your ZeeDownloads Marketplace database is now up to date!';
$_['ms_db_latest'] = 'Your ZeeDownloads Marketplace database is already up to date!';

$_['heading_title'] = '<b>[ZeeDownloads]</b> Digital Marketplace';
...
// Menu
$_['ms_menu_multiseller'] = 'ZeeDownloads';
...
$_['ms_config_enable_rte_note'] = 'Enable Rich Text Editor for product and seller description fields. To use this function, you need to copy the ckeditor javascript library folder from the admin (admin/view/javascript) to the catalog (catalog/view/javascript/zeedownloads)';
...
$_['ms_config_enable_seo_urls_seller_note'] = 'This option will generate SEO-friendly URLs for new sellers. SEO URLs need to be enabled in ZeeStore to use this.';
$_['ms_config_enable_seo_urls_product'] = 'Generate SEO URLs for new products (experimental)';
$_['ms_config_enable_seo_urls_product_note'] = 'This option will generate SEO-friendly URLs for new product. SEO URLs need to be enabled in ZeeStore to use this. Experimental, especially for non-English stores.';
...
$_['ms_config_attribute_display_mm'] = 'ZeeDownloads';
$_['ms_config_attribute_display_oc'] = 'ZeeStore';
...
$_['ms_config_hide_email_in_email_note'] = 'Hides customer and seller email addresses in the emails sent by ZeeDownloads';
